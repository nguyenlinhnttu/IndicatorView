...
public class IndicatorView extends View implements IndicatorInterface, ViewPager.OnPageChangeListener {
    ...
    public IndicatorView(Context context, @Nullable AttributeSet attrs) {
        ...
        this.radiusUnselected = typedArray.getDimensionPixelSize(R.styleable.IndicatorView_hado_radius_selected,DEFAULT_RADIUS_SELECTED);
        ...
        this.distance = typedArray.getDimensionPixelSize(R.styleable.IndicatorView_hado_distance,DEFAULT_DISTANCE);
    ...
    private void initDotView(int count) throws PagesLessException {
    ...
    public void setViewPager(ViewPager viewPager) throws PagesLessException {
        ...
        initDotView(viewPager.getAdapter().getCount());
        onPageSelected(0);
    }
